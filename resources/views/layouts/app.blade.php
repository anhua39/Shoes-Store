                ...
                <div class="row align-items-center">
                        ...
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    ...
                                    <li>Dinner value deals - Save more with coupons</li>
                                    <li>Save up to 35% today</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            <ul>
                                <li><i class="fi-rs-key"></i><a href="login.html">Login</a>/<a href="register.html">Register</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    <li class="has-children">
                                        <a href="shop.html"><i class="surfsidemedia-font-dress"></i>Quần áo nữ</a>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <li class="position-static"><a href="#">Our Collections</a>
                                        <ul class="mega-menu">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>391A NAM KY KHOI NGHIA, VO THI SAU WARD, DISTRICT 3, HO CHI MINH CITY
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+84 1234-567-891
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>top1server@fpt.edu.vn
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">Shoes Store</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
