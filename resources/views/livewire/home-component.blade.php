...
<main class="main">
                        ...
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    <h4 class="animated">Exchange offers</h4>
                                    <h2 class="animated fw-900" style="font-family: 'Alfa Slab One', cursive;font-family: 'Roboto', sans-serif;">Dinner value offer</h2>
                                    <p><h1 class="animated fw-900 text-brand" style="font-family: 'Alfa Slab One', cursive;font-family: 'Roboto', sans-serif;">Across all products</h1></p>
                                    <p class="animated">Save more with coupons & up to 50% off</p>
                                    <a class="animated btn btn-brush btn-brush-3" href="product-details.html"> Buy Now </a>
                                </div>
                            </div>
                ...
                <div class="single-hero-slider single-animation-wrap">
                    <div class="container">
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    <h4 class="animated">Attractive promotions</h4>
                                    <h2 class="animated fw-900" style="font-family: 'Alfa Slab One', cursive;font-family: 'Roboto', sans-serif;">Fashion trends</h2>
                                    <h1 class="animated fw-900 text-7" style="font-family: 'Alfa Slab One', cursive;font-family: 'Roboto', sans-serif;">Great collection</h1>
                                    <p class="animated">Save more with coupons & up to 50% off</p>
                                    <a class="animated btn btn-brush btn-brush-2" href="product-details.html"> Explore now </a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
                            ...
                            <h4 class="bg-4">Promotion</h4>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
                            <img src="assets/imgs/theme/icons/feature-5.png" alt="">
                            <h4 class="bg-5">Congratulate</h4>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
                ...
                <div class="tab-header">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="nav-tab-one" data-bs-toggle="tab" data-bs-target="#tab-one" type="button" role="tab" aria-controls="tab-one" aria-selected="true">Prominent</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="nav-tab-two" data-bs-toggle="tab" data-bs-target="#tab-two" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Common</button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <a href="#" class="view-more d-none d-md-flex">See also<i class="fi-rs-angle-double-small-right"></i></a>
                </div>
                <!--End nav-tabs-->
            ...
            <div class="container">
                <div class="banner-img banner-big wow fadeIn animated f-none">
                    ...
                    <div class="banner-text d-md-block d-none">
                        <h4 class="mb-15 mt-40 text-brand">Repair Service</h4>
                        <h2 class="fw-600 mb-20">We are a shoe store<br> Authorized Service Providers</h2>
        ...
        <section class="popular-categories section-padding mt-15 mb-25">
            <div class="container wow fadeIn animated">
                <h3 class="section-title mb-20"><span>Common</span> Genre</h3>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-img wow fadeIn animated">
                            ...
                            <div class="banner-text">
                                ...
                                <h4>Save 20% on purchase <br>Shoe</h4>
                                <a href="shop.html">Buy Now <i class="fi-rs-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                    ...
                    <div class="col-lg-4 d-md-none d-lg-flex">
                        <div class="banner-img wow fadeIn animated  mb-sm-0">
                            ...
                            <div class="banner-text">
                                <span>Beautiful new shoes</span>
                                <h4>Shop today <br>Deals & Deals</h4>
                                <a href="shop.html">Buy Now <i class="fi-rs-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
